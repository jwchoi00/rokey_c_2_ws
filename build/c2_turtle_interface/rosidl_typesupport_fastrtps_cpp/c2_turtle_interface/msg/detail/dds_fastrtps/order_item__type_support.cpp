...
#include "c2_turtle_interface/msg/detail/order_item__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = c2_turtle_interface::msg::OrderItem;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const c2_turtle_interface::msg::OrderItem *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<c2_turtle_interface::msg::OrderItem *>(
    untyped_ros_message);
...
{
  return &c2_turtle_interface::msg::typesupport_fastrtps_cpp::_OrderItem__handle;
}
