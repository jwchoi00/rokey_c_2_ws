...
#include "c2_turtle_interface/srv/detail/order__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const c2_turtle_interface::srv::Order_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  c2_turtle_interface::srv::Order_Request & ros_message)
{
  // Member: table_number
  cdr >> ros_message.table_number;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = c2_turtle_interface::srv::Order_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const c2_turtle_interface::srv::Order_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<c2_turtle_interface::srv::Order_Request *>(
    untyped_ros_message);
...
{
  return &c2_turtle_interface::srv::typesupport_fastrtps_cpp::_Order_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, c2_turtle_interface, srv, Order_Request)() {
  return &c2_turtle_interface::srv::typesupport_fastrtps_cpp::_Order_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_c2_turtle_interface
cdr_serialize(
  const c2_turtle_interface::srv::Order_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: success
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  c2_turtle_interface::srv::Order_Response & ros_message)
{
  // Member: success
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = c2_turtle_interface::srv::Order_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const c2_turtle_interface::srv::Order_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<c2_turtle_interface::srv::Order_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &c2_turtle_interface::srv::typesupport_fastrtps_cpp::_Order_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, c2_turtle_interface, srv, Order_Response)() {
  return &c2_turtle_interface::srv::typesupport_fastrtps_cpp::_Order_Response__handle;
}
...
{
  return &c2_turtle_interface::srv::typesupport_fastrtps_cpp::_Order__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, c2_turtle_interface, srv, Order)() {
  return &c2_turtle_interface::srv::typesupport_fastrtps_cpp::_Order__handle;
}
