...
class Init_SetOrder_Response_success
{
public:
  Init_SetOrder_Response_success()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  ::table_order_interface::srv::SetOrder_Response success(::table_order_interface::srv::SetOrder_Response::_success_type arg)
  {
...
{
  return table_order_interface::srv::builder::Init_SetOrder_Response_success();
}
