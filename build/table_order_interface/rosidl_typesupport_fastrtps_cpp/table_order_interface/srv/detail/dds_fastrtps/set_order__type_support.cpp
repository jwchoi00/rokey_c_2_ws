...
#include "table_order_interface/srv/detail/set_order__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = table_order_interface::srv::SetOrder_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const table_order_interface::srv::SetOrder_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<table_order_interface::srv::SetOrder_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _SetOrder_Request__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const table_order_interface::srv::SetOrder_Request *>(
...
static size_t _SetOrder_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_SetOrder_Request(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _SetOrder_Request__callbacks = {
...
static rosidl_message_type_support_t _SetOrder_Request__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_SetOrder_Request__callbacks,
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_table_order_interface
const rosidl_message_type_support_t *
get_message_type_support_handle<table_order_interface::srv::SetOrder_Request>()
{
  return &table_order_interface::srv::typesupport_fastrtps_cpp::_SetOrder_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = table_order_interface::srv::SetOrder_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const table_order_interface::srv::SetOrder_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<table_order_interface::srv::SetOrder_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _SetOrder_Response__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const table_order_interface::srv::SetOrder_Response *>(
...
static size_t _SetOrder_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_SetOrder_Response(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _SetOrder_Response__callbacks = {
  "table_order_interface::srv",
  "SetOrder_Response",
...
static rosidl_message_type_support_t _SetOrder_Response__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_SetOrder_Response__callbacks,
  get_message_typesupport_handle_function,
};
...
{
  return &table_order_interface::srv::typesupport_fastrtps_cpp::_SetOrder_Response__handle;
}
...
static service_type_support_callbacks_t _SetOrder__callbacks = {
  "table_order_interface::srv",
  "SetOrder",
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, table_order_interface, srv, SetOrder_Request)(),
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, table_order_interface, srv, SetOrder_Response)(),
...
static rosidl_service_type_support_t _SetOrder__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_SetOrder__callbacks,
...
{
  return &table_order_interface::srv::typesupport_fastrtps_cpp::_SetOrder__handle;
}
