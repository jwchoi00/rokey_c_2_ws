...
#include "serving_robot_msgs/msg/detail/robot_state__rosidl_typesupport_fastrtps_c.h"
...
using _RobotState__ros_msg_type = serving_robot_msgs__msg__RobotState;
...
size_t get_serialized_size_serving_robot_msgs__msg__RobotState(
  const void * untyped_ros_message,
...
static uint32_t _RobotState__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_serving_robot_msgs__msg__RobotState(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_serving_robot_msgs
size_t max_serialized_size_serving_robot_msgs__msg__RobotState(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = serving_robot_msgs__msg__RobotState;
    is_plain =
      (
...
static size_t _RobotState__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_serving_robot_msgs__msg__RobotState(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, serving_robot_msgs, msg, RobotState)() {
