...
static const _TotalPrice2C_type_support_symbol_names_t _TotalPrice2C_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, serving_robot_msgs, msg, TotalPrice2C)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, serving_robot_msgs, msg, TotalPrice2C)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, serving_robot_msgs, msg, TotalPrice2C)() {
  return &::serving_robot_msgs::msg::rosidl_typesupport_c::TotalPrice2C_message_type_support_handle;
}
