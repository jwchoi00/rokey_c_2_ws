...
class GUI(QWidget):
    ...
    def __init__(self, ros_node):
        ...
        self.food_pickup_button = QPushButton("음식물 수령", self)
        self.food_pickup_button.setVisible(False)
    ...
    def on_food_pickup_button_click(self):
        self.log("Food picked up. Returning to kitchen.")
        self.food_pickup_button.setVisible(False)  # Hide the food pickup button
