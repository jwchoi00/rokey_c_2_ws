...
serving_robot_msgs__msg__RobotState__create()
{
  ...
  serving_robot_msgs__msg__RobotState * msg = (serving_robot_msgs__msg__RobotState *)allocator.allocate(sizeof(serving_robot_msgs__msg__RobotState), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(serving_robot_msgs__msg__RobotState));
  bool success = serving_robot_msgs__msg__RobotState__init(msg);
  if (!success) {
...
serving_robot_msgs__msg__RobotState__destroy(serving_robot_msgs__msg__RobotState * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    serving_robot_msgs__msg__RobotState__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
serving_robot_msgs__msg__RobotState__Sequence__init(serving_robot_msgs__msg__RobotState__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  serving_robot_msgs__msg__RobotState * data = NULL;

  if (size) {
    data = (serving_robot_msgs__msg__RobotState *)allocator.zero_allocate(size, sizeof(serving_robot_msgs__msg__RobotState), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = serving_robot_msgs__msg__RobotState__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        serving_robot_msgs__msg__RobotState__fini(&data[i - 1]);
      }
...
serving_robot_msgs__msg__RobotState__Sequence__fini(serving_robot_msgs__msg__RobotState__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      serving_robot_msgs__msg__RobotState__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  serving_robot_msgs__msg__RobotState__Sequence * array = (serving_robot_msgs__msg__RobotState__Sequence *)allocator.allocate(sizeof(serving_robot_msgs__msg__RobotState__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = serving_robot_msgs__msg__RobotState__Sequence__init(array, size);
  if (!success) {
...
serving_robot_msgs__msg__RobotState__Sequence__destroy(serving_robot_msgs__msg__RobotState__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    serving_robot_msgs__msg__RobotState__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
serving_robot_msgs__msg__RobotState__Sequence__are_equal(const serving_robot_msgs__msg__RobotState__Sequence * lhs, const serving_robot_msgs__msg__RobotState__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!serving_robot_msgs__msg__RobotState__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  serving_robot_msgs__msg__RobotState__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(serving_robot_msgs__msg__RobotState);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    serving_robot_msgs__msg__RobotState * data =
      (serving_robot_msgs__msg__RobotState *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!serving_robot_msgs__msg__RobotState__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          serving_robot_msgs__msg__RobotState__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!serving_robot_msgs__msg__RobotState__copy(
